...
export default function Stage(props) {
  const { nodes, materials } = useGLTF(
    "/models/stage/stage-process-showcase.glb"
  );
  ...
  return (
    <group {...props} dispose={null}>
      ...
      >
        <mesh
          geometry={nodes["white-plain-ground"].geometry}
          material={materials["cream-mat"]}
          scale={14.654}
          receiveShadow
        />
      ...
      >
        <mesh
          geometry={nodes["ceramic-cereal-bowl"].geometry}
          material={materials["cream-mat"]}
          castShadow
          receiveShadow
        />
...
useGLTF.preload("/models/stage/stage-process-showcase.glb");
